...
export const PostCard = ({
  ...
  return (
    <motion.article whileHover={{ y: -2 }} transition={{ type: "spring", stiffness: 300, damping: 22, duration: 0.15 }} className="bg-card border border-border rounded-2xl md:rounded-3xl overflow-hidden p-4 space-y-3 hover:shadow-[var(--shadow-card)] transition-shadow will-change-transform">
      {/* Header */}
